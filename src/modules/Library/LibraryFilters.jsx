        ...
        <div className="w-60 bg-[#0f1115] border-r border-white/5 flex flex-col">
            ...
            <div className="p-4 flex flex-col gap-2">
                <div className="flex items-center gap-2">
                    <button
                        onClick={onUpload}
                        className="flex-1 flex items-center justify-start gap-2 py-3 px-3 rounded-xl w-full text-sm font-medium bg-transparent border border-white/[0.08] text-white/70 hover:border-teal/40 hover:text-teal transition-colors backdrop-blur-sm hover:shadow-[inset_0_0_20px_rgba(0,200,180,0.04)]"
                    >
